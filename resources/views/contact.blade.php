@extends('master')
@section('title', 'The Palace Museum Cultural & Creative Products - contact')
@section('content')
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="p-5 cta-inner bg-faded text-center rounded">
                            <p class="section-heading mb-4 fw-bold">{{ $data->name}}, Message received! Thank you!</p>
                            <p class="mb-0"><span class="fw-bold">Your Email:</span> {{ $data->email}}</p>
                            <p class="mb-0"><span class="fw-bold">Your Phone:</span> {{ $data->phone}}</p>
                            <p class="mb-0"><span class="fw-bold">Message left:</span> {{ $data->message}}</p>
                        </div>
