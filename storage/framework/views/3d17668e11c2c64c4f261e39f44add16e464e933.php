    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-upper text-primary mb-3">Cultural and Creative Products</span>
                <span class="site-heading-lower">PALACE MUSEUM</span>
            </h1>
        </header>
        <!-- Navigation-->
...
<?php /**PATH C:\College_Maisonneuve\session_4_cadriciel\gugong\resources\views/master.blade.php ENDPATH**/ ?>